    ...
    modules: [
      ...
      },
      {
        ...
        lessons: [
          ...
          { id: "benchmaxxing", number: 292, title: "Benchmaxxing : quand les benchmarks deviennent le but", slug: "benchmaxxing", keywords: ["benchmaxxing", "Goodhart", "contamination", "benchmark gaming", "C-BOD", "Chatbot Arena", "LiveBench"] },
        ],
      },
      {
        id: "seminal-papers",
        ...
        lessons: [
          { id: "paper-transformer", number: 293, title: "\"Attention Is All You Need\" (2017)", slug: "paper-transformer", arxiv: ["1706.03762"] },
          { id: "paper-bert", number: 294, title: "\"BERT\" (2018)", slug: "paper-bert", arxiv: ["1810.04805"] },
          { id: "paper-gpt3", number: 295, title: "\"GPT-3 : Language Models are Few-Shot Learners\" (2020)", slug: "paper-gpt3", arxiv: ["2005.14165"] },
          { id: "paper-scaling-laws", number: 296, title: "\"Scaling Laws for Neural Language Models\" (2020)", slug: "paper-scaling-laws", arxiv: ["2001.08361"] },
          { id: "paper-chinchilla", number: 297, title: "\"Training Compute-Optimal LLMs\" / Chinchilla (2022)", slug: "paper-chinchilla", arxiv: ["2203.15556"] },
          { id: "paper-lora", number: 298, title: "\"LoRA\" (2021)", slug: "paper-lora", arxiv: ["2106.09685"] },
          { id: "paper-flash-attention", number: 299, title: "\"Flash Attention\" (2022)", slug: "paper-flash-attention", arxiv: ["2205.14135"] },
          { id: "paper-llama", number: 300, title: "\"LLaMA: Open and Efficient Foundation LMs\" (2023)", slug: "paper-llama", arxiv: ["2302.13971"] },
          { id: "paper-mamba", number: 301, title: "\"Mamba: Linear-Time Sequence Modeling\" (2023)", slug: "paper-mamba", arxiv: ["2312.00752"] },
          { id: "paper-mixtral", number: 302, title: "\"Mixtral of Experts\" (2024)", slug: "paper-mixtral", arxiv: ["2401.04088"] },
        ],
      },
    ],
  },
    ...
    modules: [
      {
        ...
        lessons: [
          { id: "vectors-matrices", number: 311, title: "Vecteurs et matrices : les briques de base", slug: "vectors-matrices" },
          { id: "matrix-operations", number: 312, title: "Opérations matricielles : multiplication, transposée, inverse", slug: "matrix-operations" },
          { id: "eigenvalues", number: 313, title: "Valeurs propres et vecteurs propres", slug: "eigenvalues" },
          { id: "svd", number: 314, title: "Décomposition en valeurs singulières (SVD)", slug: "svd" },
          { id: "vector-spaces", number: 315, title: "Espaces vectoriels, bases et projections", slug: "vector-spaces" },
          { id: "norms-distances", number: 316, title: "Normes et distances : L1, L2, cosinus", slug: "norms-distances" },
        ],
      },
      {
        id: "calcul",
        ...
        lessons: [
          { id: "derivatives", number: 317, title: "Dérivées et gradients : l'intuition géométrique", slug: "derivatives" },
          { id: "chain-rule", number: 318, title: "Règle de la chaîne : le cœur de la backpropagation", slug: "chain-rule" },
          { id: "partial-derivatives", number: 319, title: "Dérivées partielles et jacobienne", slug: "partial-derivatives" },
          { id: "taylor-series", number: 320, title: "Séries de Taylor et approximations", slug: "taylor-series" },
          { id: "integrals-ml", number: 321, title: "Intégrales en ML : marginalisation et espérance", slug: "integrals-ml" },
        ],
      },
      {
        id: "probabilites",
        ...
        lessons: [
          { id: "probability-basics", number: 322, title: "Probabilités : axiomes, conditionnelle, Bayes", slug: "probability-basics" },
          { id: "distributions", number: 323, title: "Distributions : gaussienne, Bernoulli, catégorielle, softmax", slug: "distributions" },
          { id: "expectation-variance", number: 324, title: "Espérance, variance et moments", slug: "expectation-variance" },
          { id: "maximum-likelihood", number: 325, title: "Maximum de vraisemblance (MLE) et MAP", slug: "maximum-likelihood" },
          { id: "sampling", number: 326, title: "Échantillonnage : Monte Carlo, importance sampling, MCMC", slug: "sampling" },
        ],
      },
      {
        id: "optimisation",
        title: "Optimisation",
        lessons: [
          { id: "convexity", number: 327, title: "Convexité : fonctions convexes, minima locaux vs globaux", slug: "convexity" },
          { id: "gradient-methods", number: 328, title: "Méthodes de gradient : convergence, learning rate, momentum", slug: "gradient-methods" },
          { id: "lagrange-constraints", number: 329, title: "Optimisation sous contraintes : Lagrange et KKT", slug: "lagrange-constraints" },
          { id: "numerical-stability", number: 330, title: "Stabilité numérique : overflow, underflow, log-sum-exp", slug: "numerical-stability" },
        ],
      },
      {
        ...
        lessons: [
          { id: "entropy", number: 331, title: "Entropie : mesurer l'incertitude", slug: "entropy" },
          { id: "kl-divergence", number: 332, title: "Divergence KL et cross-entropie", slug: "kl-divergence" },
          { id: "mutual-information", number: 333, title: "Information mutuelle et ses applications en ML", slug: "mutual-information" },
          { id: "game-theory", number: 334, title: "Théorie des jeux", slug: "game-theory", keywords: ["Nash", "minimax", "dilemme du prisonnier", "GAN", "multi-agent", "mechanism design", "Pareto"] },
        ],
      },
    ],
  },
    ...
    modules: [
      {
        ...
        title: "Ressources",
        lessons: [
          { id: "glossary", number: 303, title: "Glossaire IA : 200+ termes définis (A-Z)", slug: "glossary" },
          { id: "frameworks-pytorch", number: 304, title: "Outils & Frameworks : PyTorch, JAX, Hugging Face Transformers", slug: "frameworks-pytorch" },
          { id: "frameworks-llm", number: 305, title: "Frameworks LLM : LangChain, LlamaIndex, Haystack, DSPy", slug: "frameworks-llm" },
          { id: "datasets", number: 306, title: "Datasets de référence : pré-entraînement, fine-tuning, évaluation", slug: "datasets" },
          { id: "youtube-channels", number: 307, title: "Chaînes YouTube recommandées", slug: "youtube-channels" },
          { id: "podcasts-newsletters", number: 308, title: "Podcasts & Newsletters", slug: "podcasts-newsletters" },
          { id: "certifications", number: 309, title: "Certifications et parcours complémentaires", slug: "certifications" },
          { id: "communities", number: 310, title: "Communautés : r/LocalLLaMA, Hugging Face Discord, EleutherAI", slug: "communities" },
          { id: "glossaire-it", number: 311, title: "Glossaire IT : terminologie informatique pour l'IA", slug: "glossaire-it", keywords: ["API", "REST", "gRPC", "Docker", "Kubernetes", "CI/CD", "microservices", "load balancer", "reverse proxy"] },
        ],
      },
    ],
  },
