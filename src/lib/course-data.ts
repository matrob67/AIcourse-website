    ...
    modules: [
      ...
      },
      {
        ...
        lessons: [
          ...
          { id: "sai", number: 177, title: "SAI : Superhuman Adaptable Intelligence (LeCun, 2026)", slug: "sai", arxiv: ["2602.23643"], keywords: ["SAI", "AGI", "LeCun", "world model", "JEPA", "adaptation", "spécialisation"] },
          { id: "leworldmodel", number: 178, title: "LeWorldModel : JEPA stable depuis les pixels", slug: "leworldmodel", arxiv: ["2603.19312"], keywords: ["LeWM", "JEPA", "world model", "LeCun", "SIGReg", "pixels", "planning"] },
        ],
      },
      {
        ...
        lessons: [
          { id: "adversarial-attacks", number: 179, title: "Attaques adversariales : FGSM, PGD et robustesse des modeles", slug: "adversarial-attacks", arxiv: ["1412.6572", "1706.06083"] },
          { id: "prompt-injection", number: 180, title: "Prompt injection : attaques directes, indirectes et jailbreaking", slug: "prompt-injection" },
          { id: "interpretability", number: 181, title: "Interpretabilite et Explainability (XAI) : SHAP, LIME, mechanistic interpretability", slug: "interpretability", arxiv: ["1705.07874", "1602.04938"] },
          { id: "ai-safety-alignment", number: 182, title: "AI Safety et Alignement : reward hacking, RLHF, Constitutional AI", slug: "ai-safety-alignment", arxiv: ["2212.08073", "2305.18290"] },
        ],
      },
    ],
  },
    ...
    modules: [
      {
        ...
        lessons: [
          { id: "gpu-architecture", number: 179, title: "GPU : architecture, CUDA cores, tensor cores, HBM", slug: "gpu-architecture" },
          { id: "nvidia-gpus", number: 180, title: "NVIDIA H100, B200, GB200 : spécifications et comparaison", slug: "nvidia-gpus" },
          { id: "tpu", number: 181, title: "TPU (Google) : architecture et cas d'usage", slug: "tpu" },
          { id: "custom-chips", number: 182, title: "Accélérateurs spécialisés : Groq (LPU), Cerebras (WSE), Graphcore", slug: "custom-chips" },
          { id: "cuda-ecosystem", number: 183, title: "CUDA, cuDNN, NCCL : l'écosystème logiciel NVIDIA", slug: "cuda-ecosystem" },
          { id: "cloud-ai", number: 184, title: "Cloud AI : AWS SageMaker vs GCP Vertex AI vs Azure ML", slug: "cloud-ai" },
          { id: "cluster-management", number: 185, title: "Cluster management : Slurm, Kubernetes, Ray", slug: "cluster-management" },
          { id: "networking", number: 186, title: "Networking pour distributed training : InfiniBand, NVLink, NVSwitch", slug: "networking" },
          { id: "advanced-parallelism", number: 187, title: "Parallélisme avancé : Expert Parallelism, 3D parallelism, Ulysses", slug: "advanced-parallelism", keywords: ["Expert Parallelism", "3D parallelism", "Ulysses", "DeepSpeed-Ulysses", "context parallelism", "sequence parallelism avancé"] },
        ],
      },
      {
        id: "mlops-pipeline",
        ...
        lessons: [
          { id: "experiment-tracking", number: 187, title: "Experiment tracking : MLflow, Weights & Biases, Neptune", slug: "experiment-tracking" },
          { id: "data-versioning", number: 188, title: "Data versioning : DVC, LakeFS", slug: "data-versioning" },
          { id: "model-registry", number: 189, title: "Model registry et versioning : MLflow, Hugging Face Hub", slug: "model-registry" },
          { id: "ci-cd-ml", number: 190, title: "CI/CD pour ML : tests, validation, déploiement automatisé", slug: "ci-cd-ml" },
          { id: "feature-stores", number: 191, title: "Feature stores : Feast, Tecton", slug: "feature-stores" },
          { id: "monitoring-drift", number: 192, title: "Monitoring : data drift, concept drift, performance degradation", slug: "monitoring-drift" },
          { id: "ab-testing-ml", number: 193, title: "A/B testing et canary deployments pour modèles", slug: "ab-testing-ml" },
        ],
      },
      {
        id: "llmops",
        title: "LLMOps",
        lessons: [
          { id: "prompt-management", number: 194, title: "Prompt management et versioning (LangSmith, Humanloop)", slug: "prompt-management" },
          { id: "llm-eval-benchmarks", number: 195, title: "Evaluation de LLM : benchmarks automatiques", slug: "llm-eval-benchmarks" },
          { id: "llm-as-judge", number: 196, title: "LLM-as-judge : utiliser un LLM pour évaluer un LLM", slug: "llm-as-judge", keywords: ["LLM-as-a-Judge", "évaluation automatique", "pairwise", "pointwise", "position bias", "MT-Bench", "Alpaca Eval"] },
          { id: "guardrails", number: 197, title: "Guardrails : content filtering, input/output validation", slug: "guardrails" },
          { id: "safety-redteaming", number: 198, title: "Safety : jailbreak prevention, red teaming", slug: "safety-redteaming" },
          { id: "cost-optimization", number: 199, title: "Cost optimization : prompt caching, semantic caching, model routing", slug: "cost-optimization" },
          { id: "llm-observability", number: 200, title: "Observabilité LLM : LangSmith, Arize, Phoenix, Langfuse", slug: "llm-observability" },
          { id: "gateway-loadbalancing", number: 201, title: "Gateway et load balancing : LiteLLM, Portkey", slug: "gateway-loadbalancing" },
        ],
      },
      {
        id: "data-engineering",
        ...
        lessons: [
          { id: "data-pipelines", number: 202, title: "Data pipelines à grande échelle (Spark, Dask, Ray Data)", slug: "data-pipelines" },
          { id: "web-scraping", number: 203, title: "Web scraping & data collection pour datasets ML", slug: "web-scraping" },
          { id: "data-dedup", number: 204, title: "Data cleaning, deduplication (MinHash, exact dedup)", slug: "data-dedup" },
          { id: "annotation-tools", number: 205, title: "Annotation : Label Studio, Prodigy, Argilla", slug: "annotation-tools" },
          { id: "rlhf-annotation", number: 206, title: "Annotation RLHF : outils et pipelines", slug: "rlhf-annotation" },
          { id: "synthetic-data", number: 207, title: "Synthetic data generation : techniques et qualité", slug: "synthetic-data" },
          { id: "data-governance", number: 208, title: "Data governance : GDPR, AI Act européen, compliance", slug: "data-governance" },
          { id: "dataloaders", number: 209, title: "Dataloaders & data pipelines pour le training", slug: "dataloaders", keywords: ["DataLoader", "PyTorch DataLoader", "streaming", "WebDataset", "Mosaic StreamingDataset", "prefetch", "num_workers"] },
        ],
      },
    ],
  },
    ...
    modules: [
      {
        ...
        lessons: [
          { id: "robotics-overview", number: 209, title: "Foundation models pour la robotique : vue d'ensemble", slug: "robotics-overview" },
          { id: "rt2", number: 210, title: "RT-2 (Google) : vision-language-action", slug: "rt2", arxiv: ["2307.15818"] },
          { id: "octo-openvla", number: 211, title: "Octo et OpenVLA : manipulation robotique open-source", slug: "octo-openvla" },
          { id: "sim-to-real", number: 212, title: "Simulation-to-real transfer : Isaac Sim, MuJoCo, Habitat", slug: "sim-to-real" },
          { id: "vla-models", number: 213, title: "Vision-Language-Action (VLA) models : architecture", slug: "vla-models" },
          { id: "manipulation", number: 214, title: "Manipulation robotique : grasping, dexterous manipulation", slug: "manipulation" },
          { id: "locomotion", number: 215, title: "Locomotion et navigation autonome", slug: "locomotion" },
          { id: "humanoid-robots", number: 216, title: "Humanoid robots : Tesla Optimus, Figure 01/02, 1X Neo", slug: "humanoid-robots" },
          { id: "rl-robotics", number: 217, title: "Reinforcement learning pour la robotique : PPO, SAC, TD3", slug: "rl-robotics" },
          { id: "world-models", number: 218, title: "World models pour la robotique et la planification", slug: "world-models" },
        ],
      },
      {
        id: "medical",
        ...
        lessons: [
          { id: "medical-llms", number: 219, title: "Medical LLMs : Med-PaLM 2, BioGPT, PMC-LLaMA", slug: "medical-llms" },
          { id: "medical-imaging", number: 220, title: "Medical imaging : radiology AI (détection, segmentation)", slug: "medical-imaging" },
          { id: "pathology-ai", number: 221, title: "Pathology AI : analyse de lames histologiques", slug: "pathology-ai" },
          { id: "drug-discovery", number: 222, title: "Drug discovery : AlphaFold 3 et protein structure", slug: "drug-discovery", arxiv: ["2402.04845"] },
          { id: "drug-design-diffusion", number: 223, title: "Diffusion models pour drug design : molécules et protéines", slug: "drug-design-diffusion" },
          { id: "clinical-nlp", number: 224, title: "Clinical NLP : extraction d'info, résumé de dossiers, CDS", slug: "clinical-nlp" },
          { id: "federated-learning", number: 225, title: "Federated learning : training sur données distribuées", slug: "federated-learning" },
          { id: "medical-regulation", number: 226, title: "Réglementation : FDA, CE marking, SaMD, AI Act pour le médical", slug: "medical-regulation" },
        ],
      },
      {
        id: "ai-science",
        ...
        lessons: [
          { id: "alphafold", number: 227, title: "AlphaFold 1/2/3 : protein folding", slug: "alphafold" },
          { id: "weather-climate", number: 228, title: "Weather & climate : GraphCast, GenCast", slug: "weather-climate", arxiv: ["2212.12794"] },
          { id: "materials-discovery", number: 229, title: "Materials discovery : GNoME (Google)", slug: "materials-discovery", arxiv: ["2310.01308"] },
          { id: "math-reasoning", number: 230, title: "Mathematical reasoning : AlphaGeometry, AlphaProof", slug: "math-reasoning" },
          { id: "scientific-llms", number: 231, title: "Scientific LLMs : Galactica, SciBERT, domain-specific models", slug: "scientific-llms" },
          { id: "ai-physics", number: 232, title: "AI pour la physique : simulations, accélérateurs de particules", slug: "ai-physics" },
          { id: "ai-chemistry", number: 233, title: "AI pour la chimie : retrosynthesis, molecular generation", slug: "ai-chemistry" },
        ],
      },
    ],
  },
    ...
    modules: [
      {
        ...
        lessons: [
          { id: "mistral-history", number: 234, title: "Histoire de Mistral AI : fondation, fondateurs, vision", slug: "mistral-history" },
          { id: "mistral-open-source", number: 235, title: "Stratégie open-weight vs propriétaire : pourquoi et comment", slug: "mistral-open-source" },
          { id: "mistral-sovereignty", number: 236, title: "Positionnement européen & souveraineté numérique", slug: "mistral-sovereignty" },
          { id: "mistral-funding", number: 237, title: "Levées de fonds, valorisation, investisseurs", slug: "mistral-funding" },
        ],
      },
      {
        id: "mistral-models",
        ...
        lessons: [
          { id: "mistral-7b", number: 238, title: "Mistral 7B : le premier modèle, architecture et impact", slug: "mistral-7b", arxiv: ["2310.06825"], links: [{ label: "Blog", url: "https://mistral.ai/news/announcing-mistral-7b/" }] },
          { id: "mixtral-8x7b", number: 239, title: "Mixtral 8x7B : premier MoE open-source grand public", slug: "mixtral-8x7b", arxiv: ["2401.04088"], links: [{ label: "Blog", url: "https://mistral.ai/news/mixtral-of-experts" }] },
          { id: "mixtral-8x22b", number: 240, title: "Mixtral 8x22B : scaling du MoE", slug: "mixtral-8x22b", links: [{ label: "Blog", url: "https://mistral.ai/news/mixtral-8x22b/" }] },
          { id: "mistral-large-3", number: 241, title: "Mistral Large 3 : le flagship frontier", slug: "mistral-large-3", links: [{ label: "Blog", url: "https://mistral.ai/news/mistral-3" }] },
          { id: "mistral-medium-3", number: 242, title: "Mistral Medium 3 : équilibre coût/performance", slug: "mistral-medium-3", links: [{ label: "Modèles", url: "https://mistral.ai/models" }] },
          { id: "mistral-small-4", number: 243, title: "Mistral Small 4 : efficacité et rapidité", slug: "mistral-small-4", links: [{ label: "Modèles", url: "https://mistral.ai/models" }] },
          { id: "ministral", number: 244, title: "Ministral 3B / 8B / 14B : modèles edge", slug: "ministral", links: [{ label: "Blog", url: "https://mistral.ai/news/mistral-3" }] },
          { id: "pixtral-12b", number: 245, title: "Pixtral 12B : multimodal vision + texte", slug: "pixtral-12b", links: [{ label: "Modèles", url: "https://mistral.ai/models" }] },
          { id: "mistral-nemo", number: 246, title: "Mistral NeMo 12B : multilingual open-source (collab NVIDIA)", slug: "mistral-nemo", links: [{ label: "Blog", url: "https://mistral.ai/news/mistral-nemo" }] },
          { id: "codestral", number: 247, title: "Codestral : spécialiste code", slug: "codestral", links: [{ label: "Blog", url: "https://mistral.ai/news/codestral/" }] },
          { id: "devstral", number: 248, title: "Devstral 2 & Devstral Small 2 : coding nouvelle génération", slug: "devstral", links: [{ label: "Blog", url: "https://mistral.ai/news/mistral-3" }] },
          { id: "leanstral", number: 249, title: "Leanstral : preuves formelles pour code vérifiable", slug: "leanstral", links: [{ label: "Blog", url: "https://mistral.ai/news/leanstral" }, { label: "Docs", url: "https://docs.mistral.ai/models/leanstral-26-03" }] },
          { id: "magistral-model", number: 250, title: "Magistral (v1.2) : reasoning multilingue", slug: "magistral-model", arxiv: ["2506.10910"], links: [{ label: "Blog", url: "https://mistral.ai/news/magistral" }] },
          { id: "mistral-embed", number: 250, title: "Mistral Embed : embeddings pour recherche sémantique", slug: "mistral-embed", links: [{ label: "Docs", url: "https://docs.mistral.ai/capabilities/embeddings/" }] },
          { id: "mistral-models-comparison", number: 251, title: "Comparaison des modèles Mistral : quand utiliser lequel ?", slug: "mistral-models-comparison" },
        ],
      },
      {
        ...
        lessons: [
          { id: "mistral-moe", number: 252, title: "Architecture MoE chez Mistral : routing sparse, 8 groupes d'experts", slug: "mistral-moe" },
          { id: "mistral-swa", number: 253, title: "Sliding Window Attention : implémentation Mistral", slug: "mistral-swa" },
          { id: "mistral-tokenization", number: 254, title: "Tokenization Mistral : vocabulaire 32K, choix et trade-offs", slug: "mistral-tokenization" },
          { id: "mistral-training-infra", number: 255, title: "Training infrastructure : NVIDIA Hopper, HBM3e, scaling", slug: "mistral-training-infra" },
          { id: "mistral-context-windows", number: 256, title: "Évolution des context windows : 32K → 128K → 256K", slug: "mistral-context-windows" },
          { id: "mistral-release-process", number: 257, title: "Open-weight release process : licences, Hugging Face, GGUF", slug: "mistral-release-process" },
        ],
      },
      {
        id: "mistral-products",
        ...
        lessons: [
          { id: "la-plateforme", number: 258, title: "La Plateforme : API, modèles, free tier", slug: "la-plateforme", links: [{ label: "Blog", url: "https://mistral.ai/news/la-plateforme" }, { label: "Docs API", url: "https://docs.mistral.ai/api" }] },
          { id: "le-chat", number: 259, title: "Le Chat : Free / Pro / Enterprise", slug: "le-chat", links: [{ label: "Page produit", url: "https://mistral.ai/products/le-chat" }] },
          { id: "mistral-studio", number: 260, title: "Mistral AI Studio : plateforme enterprise production", slug: "mistral-studio", links: [{ label: "Page", url: "https://mistral.ai/products/studio" }] },
          { id: "mistral-forge", number: 261, title: "Mistral Forge : build-your-own AI enterprise", slug: "mistral-forge" },
          { id: "mistral-ocr", number: 262, title: "Mistral OCR : reconnaissance de documents", slug: "mistral-ocr", links: [{ label: "Blog", url: "https://mistral.ai/news/mistral-ocr" }] },
          { id: "mistral-vibe", number: 263, title: "Mistral Vibe : CLI pour dev assisté par IA", slug: "mistral-vibe" },
        ],
      },
      {
        id: "mistral-api",
        ...
        lessons: [
          { id: "mistral-function-calling", number: 264, title: "Function calling Mistral : design patterns et exemples", slug: "mistral-function-calling", links: [{ label: "Docs", url: "https://docs.mistral.ai/capabilities/function_calling" }] },
          { id: "mistral-json-mode", number: 265, title: "JSON mode & Structured output : json_object vs json_schema", slug: "mistral-json-mode", links: [{ label: "Docs", url: "https://docs.mistral.ai/capabilities/structured_output/json_mode" }] },
          { id: "mistral-finetuning-api", number: 266, title: "Fine-tuning API : workflow, datasets, hyperparamètres", slug: "mistral-finetuning-api", links: [{ label: "Docs", url: "https://docs.mistral.ai/capabilities/fine_tuning/" }] },
          { id: "mistral-guardrails", number: 267, title: "Guardrails & Moderation : safe_prompt, content filtering", slug: "mistral-guardrails", links: [{ label: "Docs", url: "https://docs.mistral.ai/capabilities/guardrailing" }] },
          { id: "mistral-batch-api", number: 268, title: "Batch API et optimisation des coûts", slug: "mistral-batch-api" },
          { id: "mistral-agents-api", number: 269, title: "Agents API et workflows Mistral", slug: "mistral-agents-api" },
        ],
      },
      {
        ...
        lessons: [
          { id: "mistral-azure", number: 270, title: "Mistral sur Azure : partnership, Azure AI Studio", slug: "mistral-azure", links: [{ label: "Azure Blog", url: "https://azure.microsoft.com/en-us/blog/microsoft-and-mistral-ai-announce-new-partnership-to-accelerate-ai-innovation-and-introduce-mistral-large-first-on-azure/" }] },
          { id: "mistral-aws-gcp", number: 271, title: "Mistral sur AWS Bedrock et GCP", slug: "mistral-aws-gcp" },
          { id: "mistral-compute", number: 272, title: "Mistral Compute : infrastructure souveraine (datacenter France)", slug: "mistral-compute" },
          { id: "mistral-dassault", number: 273, title: "Partenariat Dassault Systèmes / OUTSCALE : cloud souverain", slug: "mistral-dassault", links: [{ label: "Annonce", url: "https://www.3ds.com/newsroom/press-releases/new-era-sovereign-ai-dassault-systemes-and-mistral-ai-deepen-their-partnership/" }] },
          { id: "mistral-on-premise", number: 274, title: "Déploiement on-premise et self-hosted", slug: "mistral-on-premise" },
        ],
      },
    ],
  },
    ...
    modules: [
      {
        ...
        lessons: [
          { id: "comparatif-produits-api", number: 275, title: "Comparatif produits & API : OpenAI vs Anthropic vs Google vs Mistral (mars 2026)", slug: "comparatif-produits-api", keywords: ["OpenAI", "Anthropic", "Google", "Gemini", "Mistral", "GPT-5", "Claude", "pricing", "API", "function calling", "agents", "comparatif"] },
          { id: "openai", number: 276, title: "OpenAI : GPT-4/4o, o1/o3/o4, Sora", slug: "openai" },
          { id: "google-deepmind", number: 277, title: "Google DeepMind : Gemini, Gemma, recherche fondamentale", slug: "google-deepmind" },
          { id: "anthropic", number: 278, title: "Anthropic : Claude, Constitutional AI, safety-first", slug: "anthropic", arxiv: ["2212.08073"] },
          { id: "meta-ai", number: 279, title: "Meta AI : LLaMA 1/2/3, stratégie open-source", slug: "meta-ai", arxiv: ["2302.13971", "2407.21783"] },
          { id: "xai", number: 280, title: "xAI : Grok, architecture, Colossus cluster", slug: "xai" },
          { id: "deepseek", number: 281, title: "DeepSeek : DeepSeek-V2/V3, R1, MoE chinois", slug: "deepseek", arxiv: ["2501.12948"] },
          { id: "cohere-ai21", number: 282, title: "Cohere & AI21 Labs : enterprise NLP, Command R, Jamba", slug: "cohere-ai21" },
          { id: "hugging-face", number: 283, title: "Hugging Face : écosystème open-source, Transformers, Hub, Spaces", slug: "hugging-face" },
          { id: "nvidia-ecosystem", number: 284, title: "NVIDIA : hardware, software (CUDA, NIM, TensorRT)", slug: "nvidia-ecosystem" },
          { id: "stability-bfl", number: 285, title: "Stability AI / Black Forest Labs : Stable Diffusion, Flux", slug: "stability-bfl" },
        ],
      },
      {
        id: "benchmarks",
        ...
        lessons: [
          { id: "mmlu", number: 286, title: "MMLU et MMLU-Pro : connaissances générales", slug: "mmlu", arxiv: ["2009.03300"] },
          { id: "humaneval", number: 287, title: "HumanEval et MBPP : évaluation de code", slug: "humaneval" },
          { id: "math-gsm8k", number: 288, title: "MATH et GSM8K : raisonnement mathématique", slug: "math-gsm8k" },
          { id: "gpqa", number: 289, title: "GPQA : questions graduate-level", slug: "gpqa" },
          { id: "arc-hellaswag", number: 290, title: "ARC, HellaSwag, WinoGrande : raisonnement de bon sens", slug: "arc-hellaswag" },
          { id: "aime-benchmark", number: 291, title: "AIME et compétitions mathématiques : nouveau standard", slug: "aime-benchmark" },
          { id: "lmarena", number: 292, title: "LMArena (Chatbot Arena) : évaluation humaine ELO", slug: "lmarena" },
          { id: "benchmark-limits", number: 293, title: "Limites des benchmarks : contamination, gaming, saturation", slug: "benchmark-limits" },
          { id: "benchmaxxing", number: 294, title: "Benchmaxxing : quand les benchmarks deviennent le but", slug: "benchmaxxing", keywords: ["benchmaxxing", "Goodhart", "contamination", "benchmark gaming", "C-BOD", "Chatbot Arena", "LiveBench"] },
        ],
      },
      {
        id: "seminal-papers",
        ...
        lessons: [
          { id: "paper-transformer", number: 295, title: "\"Attention Is All You Need\" (2017)", slug: "paper-transformer", arxiv: ["1706.03762"] },
          { id: "paper-bert", number: 296, title: "\"BERT\" (2018)", slug: "paper-bert", arxiv: ["1810.04805"] },
          { id: "paper-gpt3", number: 297, title: "\"GPT-3 : Language Models are Few-Shot Learners\" (2020)", slug: "paper-gpt3", arxiv: ["2005.14165"] },
          { id: "paper-scaling-laws", number: 298, title: "\"Scaling Laws for Neural Language Models\" (2020)", slug: "paper-scaling-laws", arxiv: ["2001.08361"] },
          { id: "paper-chinchilla", number: 299, title: "\"Training Compute-Optimal LLMs\" / Chinchilla (2022)", slug: "paper-chinchilla", arxiv: ["2203.15556"] },
          { id: "paper-lora", number: 300, title: "\"LoRA\" (2021)", slug: "paper-lora", arxiv: ["2106.09685"] },
          { id: "paper-flash-attention", number: 301, title: "\"Flash Attention\" (2022)", slug: "paper-flash-attention", arxiv: ["2205.14135"] },
          { id: "paper-llama", number: 302, title: "\"LLaMA: Open and Efficient Foundation LMs\" (2023)", slug: "paper-llama", arxiv: ["2302.13971"] },
          { id: "paper-mamba", number: 303, title: "\"Mamba: Linear-Time Sequence Modeling\" (2023)", slug: "paper-mamba", arxiv: ["2312.00752"] },
          { id: "paper-mixtral", number: 304, title: "\"Mixtral of Experts\" (2024)", slug: "paper-mixtral", arxiv: ["2401.04088"] },
        ],
      },
    ],
  },
    ...
    modules: [
      {
        ...
        lessons: [
          { id: "vectors-matrices", number: 313, title: "Vecteurs et matrices : les briques de base", slug: "vectors-matrices" },
          { id: "matrix-operations", number: 314, title: "Opérations matricielles : multiplication, transposée, inverse", slug: "matrix-operations" },
          { id: "eigenvalues", number: 315, title: "Valeurs propres et vecteurs propres", slug: "eigenvalues" },
          { id: "svd", number: 316, title: "Décomposition en valeurs singulières (SVD)", slug: "svd" },
          { id: "vector-spaces", number: 317, title: "Espaces vectoriels, bases et projections", slug: "vector-spaces" },
          { id: "norms-distances", number: 318, title: "Normes et distances : L1, L2, cosinus", slug: "norms-distances" },
        ],
      },
      {
        id: "calcul",
        ...
        lessons: [
          { id: "derivatives", number: 319, title: "Dérivées et gradients : l'intuition géométrique", slug: "derivatives" },
          { id: "chain-rule", number: 320, title: "Règle de la chaîne : le cœur de la backpropagation", slug: "chain-rule" },
          { id: "partial-derivatives", number: 321, title: "Dérivées partielles et jacobienne", slug: "partial-derivatives" },
          { id: "taylor-series", number: 322, title: "Séries de Taylor et approximations", slug: "taylor-series" },
          { id: "integrals-ml", number: 323, title: "Intégrales en ML : marginalisation et espérance", slug: "integrals-ml" },
        ],
      },
      {
        id: "probabilites",
        ...
        lessons: [
          { id: "probability-basics", number: 324, title: "Probabilités : axiomes, conditionnelle, Bayes", slug: "probability-basics" },
          { id: "distributions", number: 325, title: "Distributions : gaussienne, Bernoulli, catégorielle, softmax", slug: "distributions" },
          { id: "expectation-variance", number: 326, title: "Espérance, variance et moments", slug: "expectation-variance" },
          { id: "maximum-likelihood", number: 327, title: "Maximum de vraisemblance (MLE) et MAP", slug: "maximum-likelihood" },
          { id: "sampling", number: 328, title: "Échantillonnage : Monte Carlo, importance sampling, MCMC", slug: "sampling" },
        ],
      },
      {
        id: "optimisation",
        title: "Optimisation",
        lessons: [
          { id: "convexity", number: 329, title: "Convexité : fonctions convexes, minima locaux vs globaux", slug: "convexity" },
          { id: "gradient-methods", number: 330, title: "Méthodes de gradient : convergence, learning rate, momentum", slug: "gradient-methods" },
          { id: "lagrange-constraints", number: 331, title: "Optimisation sous contraintes : Lagrange et KKT", slug: "lagrange-constraints" },
          { id: "numerical-stability", number: 332, title: "Stabilité numérique : overflow, underflow, log-sum-exp", slug: "numerical-stability" },
        ],
      },
      {
        ...
        lessons: [
          { id: "entropy", number: 333, title: "Entropie : mesurer l'incertitude", slug: "entropy" },
          { id: "kl-divergence", number: 334, title: "Divergence KL et cross-entropie", slug: "kl-divergence" },
          { id: "mutual-information", number: 335, title: "Information mutuelle et ses applications en ML", slug: "mutual-information" },
          { id: "game-theory", number: 336, title: "Théorie des jeux", slug: "game-theory", keywords: ["Nash", "minimax", "dilemme du prisonnier", "GAN", "multi-agent", "mechanism design", "Pareto"] },
        ],
      },
    ],
  },
    ...
    modules: [
      {
        ...
        title: "Ressources",
        lessons: [
          { id: "glossary", number: 305, title: "Glossaire IA : 200+ termes définis (A-Z)", slug: "glossary" },
          { id: "frameworks-pytorch", number: 306, title: "Outils & Frameworks : PyTorch, JAX, Hugging Face Transformers", slug: "frameworks-pytorch" },
          { id: "frameworks-llm", number: 307, title: "Frameworks LLM : LangChain, LlamaIndex, Haystack, DSPy", slug: "frameworks-llm" },
          { id: "datasets", number: 308, title: "Datasets de référence : pré-entraînement, fine-tuning, évaluation", slug: "datasets" },
          { id: "youtube-channels", number: 309, title: "Chaînes YouTube recommandées", slug: "youtube-channels" },
          { id: "podcasts-newsletters", number: 310, title: "Podcasts & Newsletters", slug: "podcasts-newsletters" },
          { id: "certifications", number: 311, title: "Certifications et parcours complémentaires", slug: "certifications" },
          { id: "communities", number: 312, title: "Communautés : r/LocalLLaMA, Hugging Face Discord, EleutherAI", slug: "communities" },
          { id: "glossaire-it", number: 313, title: "Glossaire IT : terminologie informatique pour l'IA", slug: "glossaire-it", keywords: ["API", "REST", "gRPC", "Docker", "Kubernetes", "CI/CD", "microservices", "load balancer", "reverse proxy"] },
        ],
      },
    ],
  },
