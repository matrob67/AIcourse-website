    ...
    modules: [
      {
        ...
        lessons: [
          { id: "openai", number: 273, title: "OpenAI : GPT-4/4o, o1/o3/o4, Sora", slug: "openai" },
          { id: "google-deepmind", number: 274, title: "Google DeepMind : Gemini, Gemma, recherche fondamentale", slug: "google-deepmind" },
          { id: "anthropic", number: 275, title: "Anthropic : Claude, Constitutional AI, safety-first", slug: "anthropic", arxiv: ["2212.08073"] },
          { id: "meta-ai", number: 276, title: "Meta AI : LLaMA 1/2/3, stratégie open-source", slug: "meta-ai", arxiv: ["2302.13971", "2407.21783"] },
          { id: "xai", number: 277, title: "xAI : Grok, architecture, Colossus cluster", slug: "xai" },
          { id: "deepseek", number: 278, title: "DeepSeek : DeepSeek-V2/V3, R1, MoE chinois", slug: "deepseek", arxiv: ["2501.12948"] },
          { id: "cohere-ai21", number: 279, title: "Cohere & AI21 Labs : enterprise NLP, Command R, Jamba", slug: "cohere-ai21" },
          { id: "hugging-face", number: 280, title: "Hugging Face : écosystème open-source, Transformers, Hub, Spaces", slug: "hugging-face" },
          { id: "nvidia-ecosystem", number: 281, title: "NVIDIA : hardware, software (CUDA, NIM, TensorRT)", slug: "nvidia-ecosystem" },
          { id: "stability-bfl", number: 282, title: "Stability AI / Black Forest Labs : Stable Diffusion, Flux", slug: "stability-bfl" },
        ],
      },
      {
        id: "benchmarks",
        ...
        lessons: [
          { id: "mmlu", number: 283, title: "MMLU et MMLU-Pro : connaissances générales", slug: "mmlu", arxiv: ["2009.03300"] },
          { id: "humaneval", number: 284, title: "HumanEval et MBPP : évaluation de code", slug: "humaneval" },
          { id: "math-gsm8k", number: 285, title: "MATH et GSM8K : raisonnement mathématique", slug: "math-gsm8k" },
          { id: "gpqa", number: 286, title: "GPQA : questions graduate-level", slug: "gpqa" },
          { id: "arc-hellaswag", number: 287, title: "ARC, HellaSwag, WinoGrande : raisonnement de bon sens", slug: "arc-hellaswag" },
          { id: "aime-benchmark", number: 288, title: "AIME et compétitions mathématiques : nouveau standard", slug: "aime-benchmark" },
          { id: "lmarena", number: 289, title: "LMArena (Chatbot Arena) : évaluation humaine ELO", slug: "lmarena" },
          { id: "benchmark-limits", number: 290, title: "Limites des benchmarks : contamination, gaming, saturation", slug: "benchmark-limits" },
        ],
      },
      {
        id: "seminal-papers",
        ...
        lessons: [
          { id: "paper-transformer", number: 291, title: "\"Attention Is All You Need\" (2017)", slug: "paper-transformer", arxiv: ["1706.03762"] },
          { id: "paper-bert", number: 292, title: "\"BERT\" (2018)", slug: "paper-bert", arxiv: ["1810.04805"] },
          { id: "paper-gpt3", number: 293, title: "\"GPT-3 : Language Models are Few-Shot Learners\" (2020)", slug: "paper-gpt3", arxiv: ["2005.14165"] },
          { id: "paper-scaling-laws", number: 294, title: "\"Scaling Laws for Neural Language Models\" (2020)", slug: "paper-scaling-laws", arxiv: ["2001.08361"] },
          { id: "paper-chinchilla", number: 295, title: "\"Training Compute-Optimal LLMs\" / Chinchilla (2022)", slug: "paper-chinchilla", arxiv: ["2203.15556"] },
          { id: "paper-lora", number: 296, title: "\"LoRA\" (2021)", slug: "paper-lora", arxiv: ["2106.09685"] },
          { id: "paper-flash-attention", number: 297, title: "\"Flash Attention\" (2022)", slug: "paper-flash-attention", arxiv: ["2205.14135"] },
          { id: "paper-llama", number: 298, title: "\"LLaMA: Open and Efficient Foundation LMs\" (2023)", slug: "paper-llama", arxiv: ["2302.13971"] },
          { id: "paper-mamba", number: 299, title: "\"Mamba: Linear-Time Sequence Modeling\" (2023)", slug: "paper-mamba", arxiv: ["2312.00752"] },
          { id: "paper-mixtral", number: 300, title: "\"Mixtral of Experts\" (2024)", slug: "paper-mixtral", arxiv: ["2401.04088"] },
        ],
      },
    ],
  },
    ...
    modules: [
      {
        ...
        lessons: [
          { id: "vectors-matrices", number: 309, title: "Vecteurs et matrices : les briques de base", slug: "vectors-matrices" },
          { id: "matrix-operations", number: 310, title: "Opérations matricielles : multiplication, transposée, inverse", slug: "matrix-operations" },
          { id: "eigenvalues", number: 311, title: "Valeurs propres et vecteurs propres", slug: "eigenvalues" },
          { id: "svd", number: 312, title: "Décomposition en valeurs singulières (SVD)", slug: "svd" },
          { id: "vector-spaces", number: 313, title: "Espaces vectoriels, bases et projections", slug: "vector-spaces" },
          { id: "norms-distances", number: 314, title: "Normes et distances : L1, L2, cosinus", slug: "norms-distances" },
        ],
      },
      {
        id: "calcul",
        ...
        lessons: [
          { id: "derivatives", number: 315, title: "Dérivées et gradients : l'intuition géométrique", slug: "derivatives" },
          { id: "chain-rule", number: 316, title: "Règle de la chaîne : le cœur de la backpropagation", slug: "chain-rule" },
          { id: "partial-derivatives", number: 317, title: "Dérivées partielles et jacobienne", slug: "partial-derivatives" },
          { id: "taylor-series", number: 318, title: "Séries de Taylor et approximations", slug: "taylor-series" },
          { id: "integrals-ml", number: 319, title: "Intégrales en ML : marginalisation et espérance", slug: "integrals-ml" },
        ],
      },
      {
        id: "probabilites",
        ...
        lessons: [
          { id: "probability-basics", number: 320, title: "Probabilités : axiomes, conditionnelle, Bayes", slug: "probability-basics" },
          { id: "distributions", number: 321, title: "Distributions : gaussienne, Bernoulli, catégorielle, softmax", slug: "distributions" },
          { id: "expectation-variance", number: 322, title: "Espérance, variance et moments", slug: "expectation-variance" },
          { id: "maximum-likelihood", number: 323, title: "Maximum de vraisemblance (MLE) et MAP", slug: "maximum-likelihood" },
          { id: "sampling", number: 324, title: "Échantillonnage : Monte Carlo, importance sampling, MCMC", slug: "sampling" },
        ],
      },
      {
        id: "optimisation",
        title: "Optimisation",
        lessons: [
          { id: "convexity", number: 325, title: "Convexité : fonctions convexes, minima locaux vs globaux", slug: "convexity" },
          { id: "gradient-methods", number: 326, title: "Méthodes de gradient : convergence, learning rate, momentum", slug: "gradient-methods" },
          { id: "lagrange-constraints", number: 327, title: "Optimisation sous contraintes : Lagrange et KKT", slug: "lagrange-constraints" },
          { id: "numerical-stability", number: 328, title: "Stabilité numérique : overflow, underflow, log-sum-exp", slug: "numerical-stability" },
        ],
      },
      {
        ...
        lessons: [
          { id: "entropy", number: 329, title: "Entropie : mesurer l'incertitude", slug: "entropy" },
          { id: "kl-divergence", number: 330, title: "Divergence KL et cross-entropie", slug: "kl-divergence" },
          { id: "mutual-information", number: 331, title: "Information mutuelle et ses applications en ML", slug: "mutual-information" },
        ],
      },
    ],
  },
    ...
    modules: [
      {
        ...
        title: "Ressources",
        lessons: [
          { id: "glossary", number: 301, title: "Glossaire IA : 200+ termes définis (A-Z)", slug: "glossary" },
          { id: "frameworks-pytorch", number: 302, title: "Outils & Frameworks : PyTorch, JAX, Hugging Face Transformers", slug: "frameworks-pytorch" },
          { id: "frameworks-llm", number: 303, title: "Frameworks LLM : LangChain, LlamaIndex, Haystack, DSPy", slug: "frameworks-llm" },
          { id: "datasets", number: 304, title: "Datasets de référence : pré-entraînement, fine-tuning, évaluation", slug: "datasets" },
          { id: "youtube-channels", number: 305, title: "Chaînes YouTube recommandées", slug: "youtube-channels" },
          { id: "podcasts-newsletters", number: 306, title: "Podcasts & Newsletters", slug: "podcasts-newsletters" },
          { id: "certifications", number: 307, title: "Certifications et parcours complémentaires", slug: "certifications" },
          { id: "communities", number: 308, title: "Communautés : r/LocalLLaMA, Hugging Face Discord, EleutherAI", slug: "communities" },
        ],
      },
    ],
  },
